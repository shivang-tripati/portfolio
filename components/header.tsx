...
export default function Header() {
  ...
  return (
    <header className='z-[999] relative'>
      ...
      backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[35rem] sm:rounded-full'
      ...
      <nav className='flex fixed top-[0.15rem] left-1/2 h-12 -translate-x-1/2 py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0'>
        ...
        text-[0.9rem] font-medium text-gray-500 dark:text-gray-400 sm:w-[initial] sm:flex-nowrap sm:gap-5'>
          {links.map((link) => (
